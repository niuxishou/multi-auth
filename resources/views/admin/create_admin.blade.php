...
<html lang="ja">
 ...
 <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="/admin/list_admin" class="nav-link active">
                    管理者一覧・編集
                </a>
            </li>
            <li class="nav-item">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <div class="card">
                <div class="card-header bold" style="font-size:25px;">新規管理者登録</div>
                <div class="card-body">
...
@endif
                <form method="POST" action="create_admin" accept-charset="UTF-8">
                    {{ csrf_field() }}

...
<html lang="ja">
    <head>
        ...
        <title>ルーム・サロン管理 | ユーザー情報閲覧</title>
...
<div class="card">
                <div class="card-header bold" style="font-size:25px;">{{ $user->name }}さんの登録情報を閲覧</div>
                <div class="card-body">
	<p><a href="/admin/edit_user?user_id={{$user->id}}">このユーザー情報を編集</a></p>
                    ...
                    <div class="form-group">
                        <div class="col-sm-3 col-md-3">
                            <div class="form-layout-title form-style-required" style="vertical-align:middle;">住所（郵便番号）</div>
                        </div>

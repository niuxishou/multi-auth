...
<html lang="ja">
    <head>
        ...
        <title>ルーム・サロン管理 | スタイリスト管理者情報変更</title>
 ...
 <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <div class="card">
                <div class="card-header bold" style="font-size:25px;">スタイリスト管理者の登録情報を編集</div>
                <div class="card-body">
...
@endif
                <form method="POST" action="/admin/edit_stylistadmin?stylistadmin_id={{$stylistadmin->id}}" accept-charset="UTF-8">
                    {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <input class="form-field{{ $errors->has('name') ? ' error' : '' }}" type="text" value="@if(old('name')=="") {{$stylistadmin->name}} @else {{old('name')}} @endif" name="name" id="name" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-3 col-md-3">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <input class="form-field{{ $errors->has('email') ? ' error' : '' }}" type="text" value="@if(old('email')=="") {{$stylistadmin->email}} @else {{old('email')}} @endif" name="email" id="email" />
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">

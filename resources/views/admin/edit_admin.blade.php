...
<html lang="ja">
 ...
 <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="/admin/edit_admin" class="nav-link active">
                    管理者一覧・編集
                </a>
            </li>
            <li class="nav-item">
                ...
                <form method="POST" action="/admin/edit_admin?admin_id={{ $admin->id }}" accept-charset="UTF-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <input class="form-field{{ $errors->has('email') ? ' error' : '' }}" type="text" value="@if(old('email')=="") {{$admin->email}} @else {{old('email')}} @endif" name="email" id="email" />
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">

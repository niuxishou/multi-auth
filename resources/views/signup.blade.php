...
@endif
                <form method="POST" action="{{ route('signup') }}" accept-charset="UTF-8">
                    ...
                    <div class="form-group">
                        <div class="col-sm-3 col-md-3">
                            <div class="form-layout-title form-style-required">パスワード<span class="hissu">※</span></div>
                        </div>
                        <div class="col-sm-9 col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-md-9">
                            <input class="form-field{{ $errors->has('address_3') ? ' error' : '' }}" type="text" name="address_3" id="address_3" value="{{ old('address_3') }}" />
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
